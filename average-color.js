function addImage(file) {
  ...
  element.innerHTML = `<div class="cell image"><h2>Input</h2><img alt="Input image" draggable="false"></div><div class="cell color"><h2>Output</h2><div class="box" aria-description="Most dominant color"></div><ul><li class="rgb"></li><li class="hex"></li><li class="hsl"></li></ul></div>`;
